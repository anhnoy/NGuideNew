    ...
    <div class="card">
      ...
      <div class="lg:mt-8 mt-4 flex justify-center items-center px-5 lg:px-0">
        <div class="w-full flex flex-col lg:flex-row items-center">
          ...
          <div class="lg:w-1/2 w-full mt-6 lg:mt-0 lg:ml-8 text-center lg:text-left">
            <p>
              <span class="text-[#5E5F61] font-normal lg:text-xl text-sm">
                광활한 자연 환경에서 힐링하고, </span><br class="block lg:hidden" />
              <span class="text-[#5E5F61] font-medium text-sm lg:text-xl">
                다양한 액티비티를 즐길 수 있는 라오스
              </span>
            </p>
            <p class="text-[#152123] font-normal text-base lg:text-3xl mt-3">
              소중한 사람들과 함께 떠나 보세요!
            </p>
            ...
            <div class="mt-6 lg:mt-14 flex justify-center lg:justify-start">
              <a href="https://www.youtube.com/watch?v=fwcB7yPLOOY" target="_blank" rel="noopener noreferrer">
                <button
                  ...
                  더 많은 영상 보러 가기
                  <img class="ml-2 w-[16px] h-[16px]" src="../../assets/icons/nextLink.svg" alt="">
                </button>
              </a>
            </div>
          </div>
