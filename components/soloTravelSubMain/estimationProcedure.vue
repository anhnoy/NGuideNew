<template>
  <div
    class="bg-white p-[10px] lg:p-8 rounded-xl shadow-md w-full m-4 lg:m-12 h-[227px] lg:w-full lg:h-[200px]"
  >
    <div
    ...
    >
      ...
      <div class="flex justify-center items-center space-x-5">
        <div class="flex flex-col items-center lg:px-8">
          ...
          >
            ...
            />
            <p
              class="text-[10px] break-words lg:text-[12px] w-[50px] h-[18px] lg:w-[150px] lg:h-[46px] lg:-my-3"
            >
              {{ "상품선택" }}
            </p>
          </div>
        ...
        <div class="flex flex-col items-center lg:px-8">
          ...
          >
            ...
            />
            <p
              class="text-[10px] lg:text-[12px] break-words w-[50px] h-[18px] lg:w-[150px] lg:h-[46px] lg:-my-3"
            >
              {{ "설문지 작성" }}
            </p>
          </div>
      ...
      <div class="flex justify-center items-center space-x-5">
        ...
        >
          ...
          >
            <img
              src="../../assets/icons/chat-online.svg"
              class="w-[20px] h-[20px] lg:w-[40px] lg:h-[40px] lg:my-5"
            />
            <p
              class="text-[10px] lg:text-[12px] break-words w-[50px] h-[18px] lg:w-[150px] lg:h-[46px] lg:-my-5"
            >
              {{ "온라인 or" }}
            </p>
            <p
              class="text-[10px] lg:text-[12px] break-words -mt-[4px] lg:-mt-[12px] w-[50px] h-[18px] lg:w-[150px] lg:h-[46px] lg:-my-5"
            >
              {{ "유선 상담" }}
            </p>
          </div>
        ...
        <div class="flex flex-col items-center lg:px-8 lg:mt-0 -mt-[28px]">
          ...
          >
            <img
              ...
              class="w-[20px] h-[20px] lg:w-[40px] lg:h-[40px] my-1 lg:my-5"
            />
            <p
              class="text-[10px] lg:text-[12px] break-words w-[50px] h-[18px] lg:w-[150px] lg:h-[46px] lg:-my-3"
            >
