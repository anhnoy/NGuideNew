  ...
  >
    ...
    >
      ...
      >
        ...
        <div class="flex flex-col items-center">
          <div
            class="w-[100px] h-[89px] lg:w-[101px] lg:pr-5 lg:h-[63px] text-[#111111] flex flex-col justify-center items-center text-center lg:space-y-4"
          >
            <p
              class="lg:w-[56px] lg:h-[17px] w-[56px] h-[17px] bg-[#386333] rounded-[20px] text-white lg:text-[12px] text-[12px]"
            >
