          ...
          <div class="hidden lg:block">
            ...
            >
              ...
              <router-link
                ...
                :class="[
                  getActiveClass('/customized-travel'),
                  'hover:text-[#6EBC30]',
                ]"
              >
              ...
              <router-link
                to="/private-packages"
                :class="[
                  getActiveClass('/private-packages'),
                  'hover:text-[#6EBC30]',
                ]"
              >
              ...
              <router-link
                to="/introduction"
                :class="[
                  getActiveClass('/introduction'),
                  'hover:text-[#6EBC30]',
                ]"
              >
                <li class="hover:text-[#6EBC30]" @click="handleFetch(1, 1)">
                  관광지 소개
                </li>
              </router-link>
              <router-link
                to="/faq"
                :class="[getActiveClass('/faq'), 'hover:text-[#6EBC30]']"
              >
                <li
              ...
              <router-link
                to="/login-quotation"
                :class="[
                  getActiveClass('/login-quotation'),
                  'hover:text-[#6EBC30]',
                ]"
              >
                <button
    ...
    <div v-if="isMobileMenuOpen">
      ...
      >
        ...
        <div class="flex justify-center space-x-12 cursor-pointer m-7">
          ...
          <router-link to="/private-packages">
            <img
              src="@/assets/icons/Frame-solo.svg"
              class="w-[100px] h-[100px]"
              alt="Pen Icon"
          /></router-link>
          <!-- <router-link to="easy-create-quotation">
        ...
        <!-- <router-link to="/corporation">
          <div
            class="flex items-center justify-between mt-7 pb-2 border-b border-[#E6E6E640] cursor-pointer"
          >
            <h2 class="text-[#FFFFFF] font-bold text-sm">기업전용 상담문의</h2>
            <img
              src="@/assets/icons/nextLink.svg"
              alt=""
              class="w-[16px] h-[16px]"
        ...
        <router-link to="/login-quotation">
          <div class="flex justify-center mt-10 cursor-pointer">
            ...
            >
              <img
                src="@/assets/icons/paperMobile.svg"
                alt="Paper Mobile Icon"
              />
...
const fetchFaqThai = async (fqtl_id, faq_type_name_kr) => {
  try {
    tab.value = 3;
