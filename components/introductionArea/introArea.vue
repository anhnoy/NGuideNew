<template>
  <div class="mx-auto text-black lg:py-[40px] lg:h-[642px] ">
    ...
    <!-- Grid container -->
    <div
      class="grid grid-cols-1 gap-[20px] lg:grid-cols-2 lg:w-[1280px] lg:h-[457px] w-[328px] mx-auto"
    >
      <!-- Card 1 -->
      <div
      ...
      >
        ...
        <div class="hidden lg:block w-[400px]">
          ...
          <p
            class="text-[16px] lg:text-[16px] break-words font-regular text-[#5E5F61]"
          >
            한국 본사 직영 자회사로 현지에서 활발하게 사업 진행중이며,​긴급한
            문제 발생 시 현지 직원들의 24시간 케어가 가능합니다.​
          </p>
          <p class="text-[16px] lg:text-[16px] break-words text-[#5E5F61]">
            한국인 가이드 : 7명 / 라오스 직원 : 31명<br />​통역(라오어, 태국어,
            한국어) 직원 : 3명​
          </p>
        </div>
        <div class="lg:hidden w-[214px]">
          ...
          <p class="text-[12px] lg:text-[18px] break-words mb-2 text-[#5E5F61]">
            한국 본사 직영 자회사로 현지에서 활발하게 사업 진행중이며,​긴급한
            문제 발생 시 현지 직원들의 24시간 케어가 가능합니다.​
          </p>
          <p class="text-[12px] lg:text-[18px] break-words text-[#5E5F61]">
            한국인 가이드 : 7명 / 라오스 직원 : 31명<br />​통역(라오어, 태국어,
            한국어) 직원 : 3명​
          </p>
        </div>
      ...
      >
        ...
        <div class="hidden lg:block w-[374px]">
          ...
          <p
            class="text-[16px] lg:text-[16px] break-words font-regular text-[#5E5F61]"
          >
            nGuide(앤가이드)는 오토앤이 직접 개발한 APP으로​ 여행 중 가이드 및
            친구와 실시간 소통, 일정 확인 및 여행 루트 확인, 가이드 위치 찾기
            등이 가능하여 안전하고 편안한 여행을 돕습니다.​
          </p>
        </div>
      ...
      >
        ...
        <div class="hidden p-2 lg:block w-[379px]">
          ...
          <p
            class="text-[16px] lg:text-[16px] break-words font-regular text-[#5E5F61]"
          >
            구조가 단순하여 일정 변경에 따른 판단이 빨라 유연한 여행이
            가능합니다.​
          </p>
          <p
            class="text-[16px] lg:text-[16px] break-words font-regular text-[#5E5F61]"
          >
            현지에 경비 전가가 없어 가이드가 고객에게 만족된 서비스를 제공이
            가능합니다.
          </p>
        </div>
        <div class="lg:hidden w-[216px]">
          ...
          <p class="text-[12px] lg:text-[18px] text-[#5E5F61]">
            구조가 단순하여 일정 변경에 따른 판단이 빨라 유연한 여행이
            가능합니다.​
          </p>
          <p class="text-[12px] lg:text-[18px] text-[#5E5F61]">
      ...
      >
        ...
        <div class="hidden p-2 lg:block w-[374px]">
          ...
          <p
            class="text-[16px] lg:text-[16px] break-words font-regular text-[#5E5F61]"
          >
            낯선 사람과의 동행없이​ 단독 가이드와 함께 단독 차량 타고​ 안전하고
            편하게 우리끼리​ 프라이빗한 여행을 즐길 수 있습니다.
          </p>
        </div>
        <div class="lg:hidden w-[214px]">
          <p
