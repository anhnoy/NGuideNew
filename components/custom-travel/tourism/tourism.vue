    ...
    <div class="mx-5">
      ...
      >
        ...
        <div class="flex flex-col items-center">
          <div class="flex sm:flex-col justify-between items-center w-[300px]">
            <div>
              <p class="text-base text-[#2F312A] font-medium sm:text-center">
                아동
              </p>
              <p class="text-xs font-normal text-[#5E5F61] mb-2 text-center">
                (만 2세~만 12세 이상)
      ...
      <div class="w-full sm:w-[650px] mx-auto px-4 p-12">
        ...
        <div class="flex flex-col items-center justify-center">
          <div class="relative w-full h-[4px] bg-[#E6E6E6] rounded-full m-4">
            <input
              type="range"
              v-model="req_bid_end"
              :min="minBudget"
              ...
              class="custom-range absolute w-full h-full opacity-0 cursor-pointer z-10"
            />
            <div
          ...
          <div class="flex justify-between items-center w-full mt-4">
            <div class="relative flex items-center flex-1">
              ...
              <label
                class="absolute right-2 top-1/2 transform -translate-y-1/2 text-[#5E5F61] text-base font-normal sm:text-sm"
                >만원</label
              >
            </div>
