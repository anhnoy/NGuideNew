        ...
        <div v-if="!isLoading" class="mb-6 w-full sm:w-[840px] mx-auto">
          ...
          <div class="grid grid-cols-2 gap-4 lg:grid-cols-3 p-2">
            <div v-for="place in tourismPlaces.slice(0, 9)" :key="place.laid" class="relative">
              <div class="card w-full border border-gray-300 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-200">
                <figure>
                  <img :src="getProfileImage(place.tourism_attr_imgs)" :alt="place.land_name" class="w-full h-[200px] object-cover">
                </figure>
                <div class="p-4">
        ...
        <div v-if="!isLoading" class="mb-6 w-full sm:w-[840px] mx-auto">
          ...
          <div class="grid grid-cols-2 gap-4 lg:grid-cols-3 p-2">
            <div v-for="activity in activityPlaces.slice(0, 9)" :key="activity.laid" class="relative">
              <div class="card w-full border border-gray-300 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-200">
                <figure>
                  <img :src="getProfileImage(activity.tourism_attr_imgs)" class="w-full h-[200px] object-cover">
                </figure>
                <div class="p-4">
                  <div class="flex items-center justify-between">
