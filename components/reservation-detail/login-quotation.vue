<template>
  <div class="flex justify-center items-center min-h-screen">
    ...
    >
      <div class="w-[600px] mx-auto mt-20">
        ...
        <div class="mb-4 flex items-center">
          <label
            for="quotationNumber"
            class="block text-sm w-32 text-center font-medium text-[#132D5C]mb-1"
            >견적번호</label
          >
          <input
            id="quotationNumber"
        ...
        <div class="mb-4 flex items-center">
          <label
            for="phone"
            class="block text-sm font-medium w-32 text-center items-center text-[#132D5C]mb-1"
            >핸드폰 번호</label
          >
          <input
            id="phone"
        ...
        <button
          @click="handleSubmit"
          class="mt-10 custom-next-button mx-auto justify-center flex"
        >
          견적서 조회하기
        </button>
      </div>
    ...
    <!-- Mobile version -->
    <div
      class="w-[100vh] h-[100vh] bg-white md:hidden flex flex-col justify-between"
    >
      <!-- Mobile header -->
      <div
        class="bg-white h-[66px] flex items-center justify-between px-4 md:hidden border-b border-gray-200"
      >
      ...
      <div class="px-4 flex-grow mt-12">
        <div class="mb-4">
          <label
            for="mobileQuotationNumber"
            class="block text-sm font-medium text-[#132D5C]mb-1"
            >견적번호</label
          >
          <input
            id="mobileQuotationNumber"
            v-model="quotationNumber"
            type="text"
