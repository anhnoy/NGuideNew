      ...
      <div class="mb-4">
        <div v-for="option in options" :key="option.value" class="mb-2">
          <label class="flex items-center cursor-pointer">
            ...
            <!-- Custom Radio Design -->
            <span class="inline-block w-5 h-5 rounded-full border-2 border-[#6EBC30] relative transition-all duration-300 ease-in-out">
...
// Props to receive options and modal state
const props = defineProps({
  isOpen: Boolean,
  options: Array,
});

// Emits for closing and submitting the modal
