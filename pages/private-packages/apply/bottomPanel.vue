<template>
  <div
    class="md:w-[1100px] w-[328px] mx-auto rounded-xl md:border-transparent pl-2"
  >
    <div>
      <div>
        <!-- 상담 통화 가능 시간 -->
        <h2
          class="text-[#152123] text-sm md:text-base font-medium mt-3 md:mt-5"
        >
          상담 통화 가능 시간
        </h2>
        <input
        ...
        />
        <h2
          class="text-[#152123] text-sm md:text-base font-medium mt-5 md:mt-5"
        >
          항공권 예약 여부
        </h2>
        <div
          class="flex flex-col mt-2 space-y-2 md:space-y-0 md:flex-row md:flex-wrap md:gap-4 md:mt-7"
        >
          <div
            v-for="option in [
          ...
          >
            ...
            <div
              ...
              :class="
                flight === option.name ? 'border-[#0EC0CB]' : 'border-[#E6E6E6]'
              "
            >
              <div
                v-if="flight === option.name"
        ...
        <div class="flex flex-col pb-2 sm:flex-row sm:gap-4 sm:items-center">
          <div class="flex flex-row items-center gap-4">
            ...
            <div
              class="flex items-center justify-center h-[52px] mt-10 md:mt-16 sm:mt-11"
            >
          ...
          <div class="flex-1 sm:flex-col">
            <div
              ...
              class="relative w-[335px] pt-3 md:pt-16"
            >
              <!-- Trigger -->
              <button
                @click="isOpen = !isOpen"
              ...
              >
                <ul class="text-sm divide-y divide-gray-100 md:text-base">
                  <li
                    ...
                    :key="item"
                    @click="selectAgeOption(item.m_id)"
        ...
        <span
          class="text-[12px] md:text-[16px] font-NotoSansKR-Regularpt text-[#5E5F61]"
          >※ 이메일로 견적서를 보내 드립니다. 정확하게 기재해 주세요.</span
        >
        ...
        <textarea
          ...
          class="w-[328px] h-[200px] md:h-[250px] md:w-[1122px] rounded-lg mt-2 md:mt-7 bg-white px-3 md:px-4 py-2 border border-[#E6E6E6] text-sm resize-none"
        ></textarea>
        ...
        <div class="items-center justify-between hidden mt-5 mb-3 md:flex">
          <div class="flex items-center">
            ...
            >
              <span class="text-[#E25C5C] mr-2 text-sm md:text-base"
                >(필수)</span
              >개인정보 수집 및 이용 동의
            </label>
          </div>
        ...
        <div class="flex items-center justify-between mt-5 mb-20 md:hidden">
          <div class="flex items-center">
            ...
            <label
              class="ml-2 text-sm font-medium text-[#2F312A] cursor-pointer"
            >
