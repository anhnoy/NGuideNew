      ...
      <div
        ...
        <div class="bg-white md:max-w-[550px] md:ml-[60px] md:mt-[50px] md:gap-[32px]">
          ...
          <div class="flex flex-col gap-4 pb-4 pl-4 md:hidden">
            ...
            <div class="flex flex-row items-center gap-4 rounded-xl bg-[#F6F6F6] p-4 w-[328px] h-[86px]">
              ...
              <span class="text-[#5E5F61] text-[12px] font-NotoSansKR-Regular w-[202px]">{{ applyStore.package.title
                }}</span>
            </div>
          </div>
          <div class="flex flex-row">
            <div>
              ...
              <!-- Tour Group -->
              <input id="req_group_name" v-model="applyStore.name" type="text" placeholder="예약자 성함을 입력해 주세요."
                ...
                <div
                  ...
                  <div class="flex flex-col">
                    <div
                      ...
                      <div>
                        <p class="text-[16px] font-medium text-[#152123] sm:text-center">
                          성인
                        </p>
                  ...
                  <div class="flex flex-col">
                    <div class="flex sm:flex-col justify-between items-center w-[300px] md:w-[164px] md:h-[91px]">
                      ...
                      <div>
                        <p class="text-[16px] text-[#152123] font-medium sm:text-center">
                          아동
                        </p>
                        <p class="text-xs font-normal text-[#5E5F61] mb-2 text-center">
                          (만 2세~만 12세 이상)
                    ...
                    <div class="flex sm:flex-col justify-between items-center w-[300px] md:w-[164px] md:h-[91px]">
                      <div class="flex items-center w-[134px] h-[34px]">
                        <img class="w-[24px] h-[24px] md:w-[30px] md:h-[30px] cursor-pointer hover:scale-[110%]" @click="
                          ...
                          " :src="applyStore.infants > 0 ? minusActive : minusGray
                            " />
                        <p
                          class="w-[60px] lg:w-[50px] lg:max-w-full h-[34px] flex justify-center items-center text-black mx-2 border border-[#E6E6E6] bg-white font-medium md:text-[16px]">
                          {{ applyStore.infants }}
              ...
              <div class="md:hidden">
                <div
                  ...
                  <h2 class="text-[#152123] text-[16px] sm:text-[16px] lg:text-[16px] font-medium md:ml-0">
                    여행 인원
                  </h2>
                  <!-- Category 1: Adults -->
            ...
            <div class="hidden md:block">
              <div class="flex rounded-xl flex-col h-[444px] w-[447px] border border-[#CFE8FD] bg-[#E9F5FF] p-4">
                <div class="flex flex-col gap-4">
                  ...
                  <div class="flex flex-row items-center gap-4 p-4 bg-white rounded-xl">
                    ...
                    <span class="text-[#152123] text-[16px] lg:text-[16px] font-medium">{{ applyStore.package.title
                      }}</span>
                  </div>
                </div>
              </div>
